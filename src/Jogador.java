...
public class Jogador {
	...
	// Comportamentos
		...
		//Esta é uma maneira de criar um baralho de cartas automaticamente, mas nós optamos por criar as cartas manualmente, assim podemos criar as nossas
	/*public static ArrayList<Carta> criarBaralho() {
		ArrayList<Carta> cartas = new ArrayList<Carta>();
		for (int i = 0; i < 3; i++) {
			cartas.add(new Carta("Carta " + i, 1 + i, i, i) );
		}
